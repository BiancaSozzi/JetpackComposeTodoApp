...
import com.project.to_do_compose.components.PriorityDropDown
import com.project.to_do_compose.data.models.Priority
import com.project.to_do_compose.ui.theme.LARGE_PADDING
import com.project.to_do_compose.ui.theme.MEDIUM_PADDING
...
fun TaskContent(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            singleLine = true // only allow 1 line of text for the title
        )
